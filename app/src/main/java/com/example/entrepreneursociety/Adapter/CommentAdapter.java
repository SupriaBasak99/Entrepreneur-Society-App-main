...
import com.example.entrepreneursociety.Dashboard;
import com.example.entrepreneursociety.MainActivity;
import com.example.entrepreneursociety.Model.Comment;
import com.example.entrepreneursociety.Model.User;
import com.example.entrepreneursociety.ProfileActivity;
...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder> {
    ...
    private List<Comment> eComments;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(eContext).inflate(R.layout.comment_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final Comment comment = eComments.get(position);
        ...
        holder.comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(eContext, ProfileActivity.class);
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Comments")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(eContext, "Comment deleted successfully!", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                    }
                                }
                            });
